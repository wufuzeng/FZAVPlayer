...
//播放器播放状态
- (void)player:(FZAVPlayerView *)player playerStatusChanged:(VideoPlayerStatus)playState;
//播放器视图改变
- (void)player:(FZAVPlayerView *)player playerStyleChanged:(VideoPlayerStyle)playerStyle;
//返回按钮点击
